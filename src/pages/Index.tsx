    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
              <span className="block text-foreground">SpaceTime Website Builder</span>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-foreground">Drag-and-Drop Editor</h3>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-foreground">SpaceTimeDB Integration</h3>
                  <p className="mt-2 text-base text-muted-foreground">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-foreground">Code Export</h3>
                  <p className="mt-2 text-base text-muted-foreground">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-foreground">Project Management</h3>
                  <p className="mt-2 text-base text-muted-foreground">
      ...
      {projects.length > 0 && (
        <div className="bg-card py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-extrabold text-foreground">Recent Projects</h2>
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {projects.slice(0, 3).map((project) => (
                <div
                  key={project.id}
                  className="bg-secondary/50 overflow-hidden shadow rounded-lg cursor-pointer hover:shadow-md transition-shadow"
